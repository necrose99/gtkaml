...
public class Gtkaml.MarkupMember : UnresolvedMarkupSubTag {
	...
	public MarkupMember (MarkupClass parent_class, string tag_name, string member_name, SymbolAccessibility access, SourceReference? source_reference = null)
	{
		base (parent_class, tag_name, source_reference);
